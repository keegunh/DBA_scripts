TTITLE "[DBname] Database|Oracle Long Run Operations"

SET LINESIZE 250
SET PAGESIZE 1000
SET HEADING ON

COL INST_ID FORMAT A12
COL STATUS FORMAT A12
COL SID FORMAT A12
COL SERIAL# FORMAT A12
COL COMMAND FORMAT A12
COL MESSAGE FORMAT A30
COL TIME_REMAINING FORMAT A19
COL ELAPSED_SECONDS FORMAT 9999999
...
SELECT SS.INST_ID,
       ...
       SS.ELAPSED_SECONDS,
       SS.USERNAME        
  FROM SYS.GV_$SESSION_LONGOPS SS,
       SYS.GV_$SESSION         S  
 WHERE S.SID             = SS.SID 
   AND SS.TIME_REMAINING > 0
 ORDER BY S.STATUS
;
