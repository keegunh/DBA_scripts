...
CREATE OR REPLACE PROCEDURE PMPBMIG.PR_MIG_CREATE_INDEX
(
...
BEGIN  
    ...
    UPDATE PMPBMIG.MSJ_MIG_INDEX_LOG 
...
EXCEPTION
   WHEN OTHERS THEN
    ...
    UPDATE PMPBMIG.MSJ_MIG_INDEX_LOG SET JOB_RESULT='FAIL:'||MIG_INDEX_RESULT 
    WHERE TABLE_NAME = V_TABLE_NAME
     AND INDEX_NAME = V_INDEX_NAME;
    COMMIT;
