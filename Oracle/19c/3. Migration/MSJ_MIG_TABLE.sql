...
CREATE TABLE MIG_USER.MSJ_MIG_TABLE
(
    OWNER           VARCHAR2(128),
...
CREATE UNIQUE INDEX MIG_USER.PK_MSJ_MIG_TABLE
ON MIG_USER.MSJ_MIG_TABLE (TABLE_NAME,MIG_SQL) 
TABLESPACE TS_MIG_USER_D01;


GRANT ALTER,DELETE,INDEX,INSERT,SELECT,UPDATE,REFERENCES,READ,ON COMMIT REFRESH,QUERY REWRITE,DEBUG,FLASHBACK ON MIG_USER.MSJ_MIG_TABLE TO ADM_USER;
GRANT SELECT ON MIG_USER.MSJ_MIG_TABLE TO DEV_USER;