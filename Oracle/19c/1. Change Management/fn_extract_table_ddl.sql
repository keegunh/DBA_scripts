CREATE OR REPLACE FUNCTION PMPBDBA.FN_EXTRACT_TABLE_DDL(
/*
------------------------------------------ INFO ------------------------------------------------------
...
ORANGE : 
	SELECT PMPBDBA.FN_EXTRACT_TABLE_DDL('OWNER','TABLE_NAME') AS DDL FROM DUAL;
...
SQLPLUS :
	...
	SELECT PMPBDBA.FN_EXTRACT_TABLE_DDL('PMPBADM','TB_STN_PYM_ORG') AS DDL FROM DUAL;
	
------------------------------------------ REQUIRED PRIVILEGE ------------------------------------------
GRANT SELECT ANY DICTIONARY TO PMPBDBA; -- PRIVILEGE REQUIRED BY FUNCTION OWNER
*/
