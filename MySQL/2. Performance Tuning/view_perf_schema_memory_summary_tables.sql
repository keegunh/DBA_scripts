...
SELECT user
     ...
     , count_alloc
     , count_free
     , ROUND(sum_number_of_bytes_alloc / POW(1024, 3), 2) AS sum_number_of_bytes_alloc_GiB
     , ROUND(sum_number_of_bytes_free  / POW(1024, 3), 2) AS sum_number_of_bytes_free_GiB
     , low_count_used
     , current_count_used
     , high_count_used
